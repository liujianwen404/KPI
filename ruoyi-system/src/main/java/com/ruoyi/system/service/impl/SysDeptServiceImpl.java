...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    {
        return deptMapper.selectDeptListWithoutDataScope();
    }
    ...
    {
        return deptMapper.selectDeptListWithoutDataScopeByCondition(dept);
    }
    ...
    {
        int result = deptMapper.checkDeptExist(deptId);
        return result > 0 ? true : false;
    }
    ...
    public SysDept selectDeptById(Long deptId)
    {
        ...
        if (sysDept != null){
            ...
            for (int i = split.length - 1; i > 1; i--) {
                sysDeptparen = deptMapper.selectDeptById(deptId);
            ...
            if (StringUtils.isNotBlank(leader)){
                SysUser sysUser = iSysUserService.selectUserById(Long.valueOf(leader));
                if (sysUser != null) {
                    sysDept.setLeaderName(sysDept == null ? "" : sysUser.getUserName());
                }
            }
        }
        return sysDept;
